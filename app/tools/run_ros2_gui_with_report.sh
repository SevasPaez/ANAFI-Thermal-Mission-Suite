...
# Ejecuta la GUI y opcionalmente un "ros2 launch" en paralelo,
# guardando LOG completo + REPORTE de errores al finalizar.
#
# Uso básico:
#   ./tools/run_ros2_gui_with_report.sh
#
# Con ROS2 setup (si no está en tu ~/.bashrc):
#   ./tools/run_ros2_gui_with_report.sh --ros /opt/ros/humble/setup.bash
#
# Con workspace:
#   ./tools/run_ros2_gui_with_report.sh --ws ~/ros2_ws/install/setup.bash
#
# Lanzar un ros2 launch en paralelo:
#   ./tools/run_ros2_gui_with_report.sh --launch "ros2 launch pkg file.launch.py"
#
# Ejecutar un comando diferente (en vez de python3 main.py):
#   ./tools/run_ros2_gui_with_report.sh --cmd "python3 -m interfaz.app_shell"
