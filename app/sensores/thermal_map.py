...
def map_and_save(input_path: str) -> str:
    """Genera una versión color-mapeada de la imagen térmica.

    Si existe una matriz térmica real asociada, colorea a partir de TempC.
    Si no, cae al comportamiento anterior sobre la imagen visual.
    """
