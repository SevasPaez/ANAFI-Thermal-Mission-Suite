...
class CameraControlsFragment(ttk.Frame):
    """
    Fragmento reutilizable con botones de Foto/Video/Gimbal para insertar en tu página de cámara.
    Debes inyectar `camera_ctrl` (CameraControl) y `gimbal_ctrl` (GimbalControl).
    """
